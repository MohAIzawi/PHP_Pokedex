...
<body>
    ...
    <main class="d-flex flex-column justify-content-center align-items-center">
        <br>
        <h1>Bienvenue sur mon Pokedex !</h1>
        <p>Vous trouverez ici la liste de tous les pokemons existants jusqu'à la génération sept!</p>
        <br>

        <h2>Volcanion est le dernier pokemon ajouté au pokédex</h2>
        <?php
        $pokemon = getAllPokemon();
        $lastPokemon = end($pokemon);
        ?>
        <div class="col-md-3 m-3">
            <div class="pokemon">
                <div class="pokemon_sprite text-center">
                    <?php $info = getPokemonInfo($lastPokemon['id']);?>
                    <a href="search2.php?id=<?php echo $info[0]['id']; ?>">
                        <img src="<?php echo getPokemonSprite($lastPokemon['Name']) ?>" alt="" style="width: 150px; height: 150px;">
                    </a>
                </div>
                <div class="pokemon_info">
                    <?php 
                    $info = getPokemonInfo($lastPokemon['id']);
                    echo "# " . $info[0]['id'] . "<br>";
                    echo $info[0]['Name'] . "<br>";
